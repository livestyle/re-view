...
import {default as pollDocument, cancelPoll, hasValidDocument} from './assets/poll-document'
...
export default class View extends EventEmitter {
	constructor(url, options={}) {
		...
		this.element.setAttribute('data-label', this.options.label || this.options.title || '');
