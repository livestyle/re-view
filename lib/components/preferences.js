...
export default tr.component({
    render(props) {
        ...
        return <div className={cl('preferences')} oninput={onInput}>
            ...
            <div className={cl('preferences-row', 'preferences-row_auto-hide')}>
                ...
                <span className={cl('preferences-comment')}>Automatically hide and show Re:view top panel. This option is available for donated users.</span>
            </div>
        </div>;
    }
});
