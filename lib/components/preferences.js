    ...
    render(props) {
        ...
        if (props.donation.handler) {
            autoHideOption = <div className={cl('preferences-row', 'preferences-row_auto-hide')}>
                ...
                <span className={cl('preferences-comment')}>Automatically hide and show Re:view top panel. This option is available for <span className={cl('preferences-donate')} onclick={toggleDonationPopup}>donated users</span>.</span>
            </div>
        }
        ...
        return <div className={cl('preferences')} oninput={onInput}>
            ...
            <div className={cl('preferences-row')}>
                ...
                <label htmlFor="preferences.disableAnimations">Disable animations</label>
            </div>
            {autoHideOption}
        </div>;
    }
